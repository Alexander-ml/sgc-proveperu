-- ===============================================
-- SEED DATA REALISTA PARA PROVEPERU
-- Solo insertar datos, NO modificar estructura
-- ===============================================
...
-- 2. USUARIOS
INSERT INTO usuario (nombres, apellidos, correo, contraseña, id_rol) VALUES
...
-- 7. VENTAS
INSERT INTO venta (id_cliente, id_usuario, fecha_venta, total) VALUES
(1, 2, NOW(), 169.80),
(2, 2, NOW(), 330.00),
(3, 1, NOW(), 568.00);
